...
class BaseDecodeHead_CPP_Part(BaseModule, metaclass=ABCMeta):
    """Base class for BaseDecodeHead_CPP_Part.
    ...
    def __init__(self,
        ...
        super(BaseDecodeHead_CPP_Part, self).__init__(init_cfg)
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, gt_part_seg, train_cfg):
        ...
        losses = self.losses(seg_logits, gt_semantic_seg, gt_part_seg)
        return losses
...
#         return output
    ...
    def losses(self, seg_logit, seg_label, seg_part_label):
